...
public class HomeAct extends AppCompatActivity {
    ...
    LinearLayout btn_ticket_pisa, btn_ticket_torii, btn_ticket_pagoda,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_ticket_torii = findViewById(R.id.btn_ticket_torii);
        ...
        btn_ticket_torii.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent gototoriiticket = new Intent(HomeAct.this, TicketDetailAct.class);
                //Meletakkan data kepada Intent
                gototoriiticket.putExtra("jenis_tiket", "Torii");
                startActivity(gototoriiticket);
            }
        });
